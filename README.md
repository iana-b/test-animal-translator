...
![Кашалот](docs/screenshots/07-whale.png)

База знаний вида: источники, статус доступа, лицензии, опубликованные поправки.

![База знаний](docs/screenshots/08-knowledge.png)
...
**Кашалот.** Числовой уверенности нет вообще. Количественной модели значения не
опубликовано, и процент не выводится.
