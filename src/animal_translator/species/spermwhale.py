...
Единственный вид, где приложение отказывается переводить по существу, а не
из-за нехватки наблюдений. Строение коды измерено и разбирается; значения у
неё нет ни одного, и авторы исследования оговаривают это прямо.
