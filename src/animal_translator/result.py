...
У каждого вида свой движок разбора, но наружу все они отдают одну структуру,
на которую опирается интерфейс.
"""
...
class UnknownKind(str, Enum):
    """Причина, по которой значение осталось неопределённым.
