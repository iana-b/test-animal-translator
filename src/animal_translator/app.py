"""Приложение FastAPI: JSON-интерфейс и страницы.

Разбор живёт в animal_translator.api и не зависит от веб-слоя; здесь только
маршруты, схемы ответов и отдача HTML.
"""
